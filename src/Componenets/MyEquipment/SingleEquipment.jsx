...
const SingleEquipment = ({ equipment, handleDelete, index }) => {
    ...
    return (
        ...
        <tbody>
            <tr>
                ...
                <td className=''>
                    <button onClick={() => handleDelete(_id)} class="px-4 py-2 flex items-center gap-3 bg-[#baf120] text-black font-semibold rounded-md">
